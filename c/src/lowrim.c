/* LOWRIM.C - Calculate the 5th lowest intensity as a function of radius for an
   ...
   "lowrim <input image> <output rfile> <image box half-width> <rfile box half-width>"
