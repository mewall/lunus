/* SAMPLT.C - Downsample a lattice
   ...
   Usage:
   		"samplt <input lattice> <output lattice>"

		Input is an input 
			lattice.  Output is a downsampled lattice.  
   */
...
/*
 * Generate the downsampled lattice:
 */

  lat->decimation_factor = decimation_factor;
  lsamplt(lat);
