/* SVECRIM.C - Calculate the scattering vector vs. radius for an
		input image.
   ...
   "svecrim <input image> <output rfile> <x origin> <y origin>"

   Input is image.  Output is a list of
        values of s(r).
