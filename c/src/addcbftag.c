/* ADDCBFTAG.C - Add a tag to a .cbf header.
   
   Author: Mike Wall
   Date: 12/18/2019
   Version: 1.
   
   "addcbftag <image in> <image out> <tag name> <tag value>" 

   Input is input image, output image, tag name, and tag value.  Output is input image with tag added in header
