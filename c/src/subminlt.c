/* SUBMINLT.C - Subtract the minimum at each radius from a lattice.
   ...
   Usage:
   		"subminlt <input lattice> <output lattice> <unit_cell_string>"
...
int main(int argc, char *argv[])
{
  ...
  switch(argc) {
    ...
    break;
    default:
    printf("\n Usage: subminlt <input lattice> <output lattice> "
	   "<cell_str>\n\n");
    exit(0);
  }
