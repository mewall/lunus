/* HKL2VTK.C - Convert h,k,l,I format to standard .vtk format.
   ...
   Usage:
   		"hkl2vtk <input lattice> <output lattice> <template>"

		Input is a lattice in hkl format, using template .vtk for header info. 
			Output is a lattice in VTK format.  
   */
 ...
 */
	...
	case 4:
	  ...
	  break;
	  default:
	  printf("\n Usage: hkl2vtk <input .hkl> <output .vtk> <template .vtk>\n\n");
	  exit(0);
	  }
