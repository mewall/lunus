/* AVGRIM_ANISO.C - Calculate the average abs(intensity-pedestal) vs. radius for an isotropic input image, smoothing rfile if desired.
   
   Author: Veronica Pillar (based on Mike Wall's avgrim.c) 
   Date: 2/28/16
   Version: 1.
   
   "avgrim_aniso <input image> <output rfile> <rolling box half-width>"
 ...
 */
	switch(argc) {
		...
		case 2:
			...
			break;
		default:
			printf("\n Usage: avgrim_aniso <input image> "
