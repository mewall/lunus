/* SUMSCIM.C - Add an image to a scalar value  pixel by pixel.
   
   Author: Mike Wall
   Date: 10/25/2016
   Version: 1.
   
   "sumscim <input image> <output image> <scalar value>" 

   Input diffraction image and scalar value.  Output is image added to scalar.
