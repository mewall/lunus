/* FFTWLT.C - Calculate the fft of a lattice using the fftw methods.
   
   Author: Mike Wall
   Date: 2/28/95; 4/29/15
   Version: 1.
   
   Usage:
   		"fftwlt <real input lattice> <imaginary input lattice>
 ...
 */
  ...
  /*
   * Read in imaginary lattice if on input line;  Otherwise, set it
   * to zero:
   */
