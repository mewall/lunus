...
def procimg(Isize1,Isize2,scale,mask_tag,A_matrix_rot,qvec,DATA,latxdim,latydim,latzdim,pedestal,beamx,beamy,maxpix,prad,procid): # this task list is getting out of control
...
if __name__=="__main__":
    ...
    for line in lines: #in genlat.input; i.e. this part is looping over images
        ...
        tasks = [(Isize1,Isize2,scale,mask_tag,A_matrix_rot,qvec_all,DATA,latxdim,latydim,latzdim,pedestal,Ibeamx,Ibeamy,maxpix,prad,procid) for procid in range(nproc)]
    ...
    # now we're out of the image loop OR SO I THOUGHT
