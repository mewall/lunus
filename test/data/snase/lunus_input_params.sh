...
# integration
xvectors_path=/projects/lunus/packages/lunus/test/data/snase/raw/tmpdir_common/xvectors.bin
diffuse_lattice_dir=/projects/lunus/packages/lunus/test/data/snase/lattices
diffuse_lattice_prefix=snc_lunus_json
lunus_image_dir=/projects/lunus/packages/lunus/test/data/snase/proc
resolution=1.6
points_per_hkl=1
